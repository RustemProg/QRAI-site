            ...
            <div className="bg-white w-2/3 h-2/3 md:w-1/2 md:h-3/6 lg:w-1/4 lg:h-2/3 rounded-lg">
                ...
                <div className=''>
                    <div className='mt-40 ml-4 mr-6 md:mt-40 lg:mt-52 flex flex-col text-xl'>
                        ...
                        <input className="pl-2 border-black border-b-2" placeholder="Password" >
                        </input>
                        <input className="pl-2 border-black border-b-2" placeholder="Confirm password">
                        </input>
                    </div>
                </div>
                <div className="mt-60 md:mt-20 lg:mt-48 flex justify-center">
