...
import logoB from "./img/QRAI.jpg";
...
function App() {
  ...
  const gradientStyle = {
    background: 'linear-gradient(90deg, rgba(255,255,255,0) 10%, rgba(255,255,255,0.5) 85.5%, rgba(0,0,0,1) 100%)',
  };
          ...
          <div style={graySp} className='flex justify-between items-center text-white'>
            ...
            {/* <nav>
              <ul className='flex justify-center items-center'>
                ...
                <li className><a href="/qrai">QRAI</a></li>
                <li className='font-Podkova ml-12'><a href="/notesgpt">NotesGPT</a></li>
              </ul>
            </nav> */}
            <div className='flex mr-6 items-center'>
              <button className='bg-white text-black rounded-lg h-9 w-32'>Log in</button>
